<style> .tab-pane{border:none !important;}
.btn-default,.btn-danger {
    border-color: transparent !important;
    width: 67px;
    border-radius: 0px;
   }
.btn-default{ background-color: #185991 !important;color:#fff !important; margin-bottom: 5px !important;}
...
<div class="">
    ...
    <div class="page-header clearfix">
        ...
        <h3 class="pull-left" style="color:#eee;">Active Orders and Removals</h3>
    ...
    <div class="row">
        ...
        <!-- Map Placeholder -->
        <div id="mapCanvas" class="col-md-12" style="border: 2px solid rgb(56, 114, 172); position: relative; overflow: hidden; height: 400px;">
...
<script type="text/javascript">
 ...
 var locations1 = [
        @foreach($install_sign_data_status1 AS $data)
                 ['<h2>Order-No. {{$data->id}}</h2> <br/> {{$data->address}} <br/> Order Status:{{$data->status}}<br/><br/><a href="edit_install_admin/{{$data->id}}">View Order</a>',{{$data->lat}},{{$data->lng}} ],
        @endforeach   
        
        @foreach($banner_order_status1 AS $data)
          ['<h2>Order-No. {{$data->id}}</h2> <br/> {{$data->address}} <br/> Order Status:{{$data->status}}<br/><br/><a href="edit_banner_admin/{{$data->id}}/{{$data->type}}">View Order</a> ',{{$data->lat}},{{$data->lng}} ],
        @endforeach 
        
        @foreach($removal_sign_status1 AS $data)
         ['<h2>Order-No. {{$data->id}}</h2> <br/> {{$data->address}} <br/> Order Status:{{$data->status}}<br/><br/><a href="view_order_admin/{{$data->id}}">View Order</a> ',{{$data->lat}},{{$data->lng}} ],
         @endforeach 
    ];
     ...
     var locations2= [
        ...
        @foreach($removal_sign_status2 AS $data)
         ['<h2>Order-No. {{$data->id}}</h2> <br/> {{$data->address}} <br/> Order Status:{{$data->status}}<br/><br/><a href="view_order_admin/{{$data->id}}">View Order</a> ',{{$data->lat}},{{$data->lng}},{{$data->id}} ],
         @endforeach 
    ];
            ...
            <form>
                ...
                <div class="form-group">
                    <!--<button type="button" class="btn btn-default btn-clear">Clear</button>-->
                     <a href="{{url('/currentorders')}}" class="btn btn-default btn-clear">Clear</a>
                </div>
                <!-- /Clear Form Button -->
        ...
        <div class="panel panel-default">
            <div class="panel-body" id="templates-body">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#simple" data-toggle="tab">Simple Orders</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                       ...
                                       @foreach($install_sign_data AS $orders_val)
                                                                    <tr>
                                        <td>
                                            O-{{$orders_val->id}}
                                        </td>
                                        <td>{{$orders_val->company_name}}
                                        </td>
                                        ...
                                        <td class="text-right">
                                                ...
                                                <a class="btn btn-default " href="edit_install_admin/{{$orders_val->id}}">Edit</a>

                                            <a class="btn btn-danger" href="delete_install_sign_admin/{{$orders_val->id}}">Delete</a>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                      ...
                                      @foreach($banner_order AS $orders_val)
                                        ...
                                        <td>
                                       <a href="edit_banner_admin/{{$orders_val->id}}/{{$orders_val->type}}">
                                        <button class="btn btn-default btn-block" style="margin-bottom:2px">Edit</button>
                                        </a>
                                         <a type="submit" href="delete_banner_admin/{{$orders_val->id}}" class="btn btn-danger btn-block">Delete</a>
                                        </td>
                                    </tr>
                                             @endforeach                           
                                                                </tbody>
                                    ...
                                    <tbody>
                                          @foreach($removal_sign AS $orders_val)
                                           ...
                                           <td>R-{{$orders_val->id}}</td>
                                            ...
                                            <td>{{$orders_val->remove_by}}</td>
                                            <td>
                             <a class="btn btn-default" href="view_order_admin/{{$orders_val->id}}">View</a>
                             <a class="btn btn-default" href="edit_removal_admin/{{$orders_val->id}}">Edit</a>
              <a type="submit" href="delete_sign_removals_admin/{{$orders_val->id}}" class="btn btn-danger btn-block">Delete</a>
                    ...
                    <div class="tab-pane fade" id="archived">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                       ...
                                       @foreach($archived_orders2 AS $orders_val)
                                                                    <tr>
                                        <td>
                                            O-{{$orders_val->id}}
                                        </td>
                    ...
                    <div class="tab-pane fade" id="simple">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                       ...
                                       @foreach($simple_orders AS $orders_val)
                                                                    <tr>
                                        <td>
                                 O-{{$orders_val->id}}
                                        </td>
                                        ...
                                        <td>{{$orders_val->description}}</td>
                                        <td>{{$orders_val->quantity}}</td>
                                        <td>
                                            {{$orders_val->date}}
                                        </td>
                                        <td class="text-right">
                                                ...
                                                <a class="btn btn-default " href="edit_order/{{$orders_val->id}}">Edit</a>

                                            <a class="btn btn-danger" href="delete_order/{{$orders_val->id }}">Delete</a>
                                ...
                                <tr>
                                    ...
                                    <th></th>
                                      ...
                                      <tr>
                                        ...
                                        <td class="text-right">      
                                            <a class="btn btn-default " href="edit_install_admin/{{$orders_val->id}}">View</a>
                                    ...
                                    <!-- @endforeach-->
                                        ...
                                        @foreach($removal_sign AS $orders_val)
                                         <tr>
                                            ...
                                            <td>{{$orders_val->remove_by}}</td>
                                            <td><a class="btn btn-default" href="view_order_admin/{{$orders_val->id}}">View</a> </td>
                                        </tr>
                                       @endforeach
                                       @foreach($banner_order AS $orders_val)
                                                                    <tr>
