...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="page-header clearfix">
                ...
                <h3 class="pull-left" style="color:#fff;">Order Overview</h3>
 ...
 @foreach($Incomplete as  $value) 
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a class="btn btn-default " href="edit_install_admin/{{$value->id}}">View</a>
                                                </td>
  ...
  @endforeach
                            ...
                            <div class="tab-pane fade in " id="Complete" style="border:none;">
                                <div class="table-responsive">
                                    <table class="table table-striped">
...
@foreach($Complete as  $value) 
  ...
  @endforeach
                            ...
                            <div class="tab-pane fade in " id="Deleted" style="border:none;">
                                <div class="table-responsive">
                                    <table class="table table-striped">
