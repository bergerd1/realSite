...
<div class="container order-info">
    ...
    <form id="theform" action="{{url('update_banner2_admin')}}" method="post" enctype="multipart/form-data" class="order-banner">
 {{csrf_field()}}
 ...
 <select class="form-control" name="status" id="status">
                                    <option value="Awaiting Printing" >
                                        Awaiting Printing
                                    </option>
                                    ...
                                    <option value="Placed" >
                                     ...
                                     <option value="Awaiting placement" >
                                       Awaiting placement
                                    </option>
                ...
                <div class="col-sm-6">
                    <div class="map-iframe-wrapper">
                        ...
                        <div  id="map"  style="border: 0"></div>
                                  <div class="form_area">
                                    <input type="text" name="location" id="location" value="{{$value->address}}">
                                   <input type="text" name="lat" value="{{$value->lat}}" id="lat">
                                  <input type="text" name="lng" value="{{$value->lng}}" id="lng">
                 </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="save-button-wrapper bottom">
                    ...
                    <a href="http://demosigns.westallisblue.com" class="btn btn-default cancel">Cancel</a>
