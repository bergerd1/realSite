...
<div style="padding-top:60px"></div>
  ...
  <?php $__currentLoopData = $sign_value1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <h1>Update Order #  <?php echo e($value->id); ?></h1>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
        ...
        <div class="col-md-9 col-md-offset-1 panel panel-default">
            <div class="panel-body">
                <form action="<?php echo e(url('update_install')); ?>" method="POST" enctype="multipart/form-data" id="update_form">
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="address-field">Location</label>
                                ...
                                <div class="input-group">
                                    ...
                                    <p id="glocation"><input type="text" name="address" value="<?php echo e($value->address); ?>"  class="form-control" readonly></p>
