...
<div class="container order-info">
    ...
    <form id="theform" action="<?php echo e(url('update_banner1')); ?>" method="post" enctype="multipart/form-data" class="order-banner">
                ...
                <div class="col-sm-6">
                    <table class="info-table">
                        ...
                        <tr>
                            ...
                            <td><?php echo e($value->user_name); ?>/ <strong><?php echo e($value->company_name); ?></strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="install_by" class="datepicker" id="Installation_date" value="<?php echo e($value->Installation_date); ?>"></td>
                                                    </tr>
                            <input type="hidden" value="<?php echo e($value->id); ?>">                        
                        <tr>
                            <td class="heading">Location:</td>
                            <td id="glocation"><input id="searchInput" type="text" name="address"  value="<?php echo e($value->address); ?>"></td>
                        </tr>
                        <tr>
 ...
 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
  ...
  <?php $__currentLoopData = $banner_value1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
         <div class="order-block">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="text" name="banner_name[]" class="banner_name" value="<?php echo e($value->banner_name); ?>">
                           <input type="hidden" value="<?php echo e($value->id); ?>" name="bannerid[]">  

                        <label for="banner_description">Description (general design, text needed, approx size):</label>
                        <textarea name="banner_description[]" rows="4"><?php echo e($value->description); ?></textarea>

                        <label for="installation_instructions">Install Instructions:</label>
                        <textarea name="installation_instructions[]" rows="4"><?php echo e($value->instructions); ?></textarea>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <input type="hidden" value="<?php echo e($value->banner_id); ?>" name="banner_id">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="save-button-wrapper bottom">
                    ...
                    <a href="<?php echo e(url('/order')); ?>" class="btn btn-default cancel">Cancel</a>
