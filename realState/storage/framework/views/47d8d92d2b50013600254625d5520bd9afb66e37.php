...
<form action="<?php echo e(url('/install_sign_data2')); ?>" class="choose-sign" method="post" id="the_form">
      ...
      <input type="hidden" value="<?php echo time(); ?>" name="time">
                        <?php $z=0; ?>
                     <?php $__currentLoopData = $instal_sign2data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $instal_sign2data_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="row" id="sign_row_<?php echo e($instal_sign2data_val->id); ?>">
                            <?php $z++; ?>
             ...
             <?php echo e(csrf_field()); ?>
                        ...
                        <div class="col-md-3">
                            <div class="image-wrapper">
                                <input type="hidden" name="template_id[]" value="<?php echo e($instal_sign2data_val->id); ?>">
                          <img id="template_<?php echo e($instal_sign2data_val->id); ?>_image" src="backend/template_picture/<?php echo e($instal_sign2data_val->temp_picture); ?>" alt="" class="img-responsive" style="border:1px solid black">
                                                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="copy-wrapper">
                               <span class="qty">0 in stock</span>
                                <span class="title"><?php echo e($instal_sign2data_val->temp_name); ?></span>
                                <span class="price"><?php echo e($instal_sign2data_val->temp_price); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="input-wrapper">
                                ...
                                <label for="qty_<?php echo e($instal_sign2data_val->id); ?>">Qty:</label>
                                
                                <input min="0" id="qty_<?php echo e($instal_sign2data_val->id); ?>" value="0" name="qty[]"
                                       aria-valuenow="0" autocomplete="off" class="ui-spinner-input sign-qty" role="spinbutton">
                                 <input type="hidden" name="quantity[]" class="quantity_<?=$z?>" id="quantity_<?php echo e($instal_sign2data_val->id); ?>" value="">
                           
                             <button style="margin-top:5px;min-width:110px" id="cart_button_<?php echo e($instal_sign2data_val->id); ?>"  type="button" onclick="sign3()"   class="btn btn-primary white-btn">
                                                                                    Add to Order
    ...
    <script>
      $(document).ready(function(){
          $('#cart_button_'+<?php echo e($instal_sign2data_val->id); ?>).click(function(){
            //  $(this).text('Remove');
           if($(this).text().trim() == 'Add to Order'){
              $(this).text('Remove');
              $('#sign_row_'+<?php echo e($instal_sign2data_val->id); ?>).css("background-color", "#a0c5f9");
              $('#quantity_'+<?php echo e($instal_sign2data_val->id); ?>).val($('#qty_'+<?php echo e($instal_sign2data_val->id); ?>).val());
              }
              else{
                   $(this).text('Add to Order');
                   $('#sign_row_'+<?php echo e($instal_sign2data_val->id); ?>).css("background-color", "white");
                   $('#qty_'+<?php echo e($instal_sign2data_val->id); ?>).val(0);
                    $('#quantity_'+<?php echo e($instal_sign2data_val->id); ?>).val('');
              }
          });
      });
    </script>
