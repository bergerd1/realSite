<?php $__env->startSection('content'); ?>
 ...
 <div class="container">
 <form action="<?php echo e(url('/place_order')); ?>" method="post" enctype="multipart/form-data">
  ...
  <?php $__currentLoopData = $company1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h4><?php echo e($company_val->company_name); ?> </h4>
                        <input type="hidden" name="company_name" value="<?php echo e($company_val->company_name); ?>">
 ...
 <?php $__currentLoopData = $user1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user_val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <h4><?php echo e($user_val->name); ?></h4>
                          <input type="hidden" name="user_name" value="<?php echo e($user_val->name); ?>">
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <!-- /Users Name -->
